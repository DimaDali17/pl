...
function renderTab(){
  ...
  if(curTab==='adv'){
    ...
    const cols=[
      ...
      {l:'Удерж.WB',t:'«Удержания» из финотчёта WB (WB Продвижение, Джем). Справочно: это те же деньги, что «Реклама» в бухгалтерии — НЕ складываются',fn:(m,f)=>{const v=meas(y,m,f).rekWB;return v?fi(v):'—';}},
