...
function rzCols(y){
  return [
    ...
    {l:'Возн. без НДС',t:'Вознаграждение маркетплейса без НДС',            fn:(m,f)=>fi(meas(y,m,f).vv)},
    ...
    {l:'Ком.итого',    t:'Реализовано − К перечислению = Вознаграждение + НДС + Эквайринг + ПВЗ', fn:(m,f)=>fi(meas(y,m,f).kom)},
