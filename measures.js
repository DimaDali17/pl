...
/* ═══════════ КОЛОНКИ ТАБЛИЦЫ ═══════════ */
const COLS=[
  {k:'zaks',l:'Заказ,шт',f:fi,t:'Заказано штук = доставки «К клиенту при продаже» + «К клиенту при отмене» из финотчёта WB (строки Логистика). Привязка по дате продажи. Report — только для сверки.'},
  ...
  {k:'zakr',l:'Заказ,руб',f:fi,t:'Сумма заказов ≈ Заказ,шт × средняя цена выкупа (vykr/vyks) того же артикул-месяца. Цены на строках логистики нет, поэтому оценка по среднему чеку.'},
