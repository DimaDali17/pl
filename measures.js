...
function agg(y,mset,filt){ const a={zaks:0,vyks:0,zakr:0,vykr:0,kom:0,rek:0,post:0,nalog:0,hran:0,dost:0,perem:0,
    rozn:0,vv:0,vvNds:0,ekvair:0,pvz:0,komOther:0,rekWB:0,rekMP:0,rekBlog:0,komp:0};
...
const COLS=[
  ...
  {k:'nalog',l:'Налог',f:fi,t:'Налог от «К перечислению» + компенсаций. EF: 7% до 01.02.2026, далее 12%. EZFR: 7%'},
  {k:'komp',l:'Компенс',f:fi,t:'Компенсации WB продавцу (брак, утеря, подмена товара). Доход — прибавляется к прибыли'},
  {k:'pribOper',l:'Пр.Опер',f:fi,t:'Операционная прибыль = Выкуп,руб − Ком.МП − Переменные − Доставка − Хранение − Налог + Компенсации'},
  ...
  {k:'pribFact',l:'Пр.Факт(асс)',f:fi,bar:'pf',t:'Факт = Выкуп,руб − Ком.МП − Перем − Доставка − Хранение − Пост.Р − Реклама − Налог − Акруалс + Компенсации'},
