...
const CACHE_VER = 'v2';   /* поднять при любом изменении WBFIN_COLS — иначе кэш отдаст старые CSV */
...
const WBFIN_COLS = [
  ...
  ['Компенсация платёжных услуг/Комиссия за интеграцию платёжных сервисов',
   ...
   'Эквайринг/Комиссии за организацию эквайринга',
   'Эквайринг/Комиссия за организацию эквайринга',
   'Возмещение эквайринга',
   'Эквайринг'],
  ...
  ['Хранение'],
  ['Удержания'],
  ['Операции на приемке', 'Приемка', 'Платная приёмка'],
];
